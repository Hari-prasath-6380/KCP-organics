...
## Quick Access
**Location**: Admin Dashboard → Left Sidebar → "About Us"

## Interface Overview

### Statistics Cards (Top)
```
📹 Total Videos  │  ✓ Active Videos  │  👁 Total Views
...
- **👁️ / 👁️‍🗨️ Toggle**: Show/hide on public page
- **🗑️ Delete**: Remove video permanently
...
2. Fill the modal form:
   - **Title** ⭐ (required): Give your video a name
   - **Video URL** ⭐ (required): Paste the video link
...
2. Status changes from "Active" → "Inactive"
...
- ✓ Use consistent display order increments
- ✓ Add videos for company story, process, testimonials
- ✓ Check video is accessible (not private on YouTube)
- ✓ Use high-quality video thumbnails

### ❌ DON'T:
- ✗ Use extremely long titles (>50 chars)
- ✗ Add duplicate videos
- ✗ Leave display order as 0 for all videos
- ✗ Use broken or private video links
- ✗ Add videos without descriptions (harder for visitors to understand)
- ✗ Forget to activate videos (they won't show up)
...
- ✓ Look for error message in browser

### Video doesn't appear on About Us page?
- ✓ Is the video "Active"? (check checkbox)
- ✓ Is it set to "about-us" category? (should be auto-set)
- ✓ Is the status "Active" (not "Inactive")?
- ✓ Hard refresh the public page (Ctrl+F5)

### YouTube video says "not available"?
- ✓ Check if video is private
- ✓ Check if video is age-restricted
- ✓ Try another YouTube video to test
- ✓ Copy URL from address bar, not share button

### Video shows but won't play?
- ✓ Check video link is still valid
...
| Cancel Form | Click × or click outside |
...
Good luck managing your About Us videos! 🎉
